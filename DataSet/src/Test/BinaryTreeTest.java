...
public class BinaryTreeTest {
	...
	public void setupScene2() {
		...
		Person person1 = new Person("Bairon", "Rodriguez", 18, "05/08/2003", "photos/1.jpg", "Cali", 166.0,"2GOZO453");
		arbol.addPerson(person1);
	}
	public void setupScene3() {
		arbol = new BinaryTree<Person>();
		Person person1 = new Person("Bairon", "Rodriguez", 18, "5/8/2003", "photos/1.jpg", "Cali", 166.0, "2GOZO453");
	...
	public void testAddToLeftAndRight() {
		...
		arbol = new BinaryTree<Person>();
		Person person2 = new Person("Juan", "Felipe", 19, "25/9/2003", "photos/12.jpg", "Cali", 167.0, "2GOZO454");
		Person person3 = new Person("Amilcar", "Jojo", 19, "21/4/2003", "photos/24.jpg", "Cali", 162.0, "2GOZO455");
		arbol.addPerson(person2);
		arbol.addPerson(person3);
	}
